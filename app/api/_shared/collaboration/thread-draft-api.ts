...
import { threadDraftService } from "@/src/composition";
...
export async function threadDraftGet(
  request: Request,
  ...
  try {
    ...
    const result = threadDraftService.readThreadDraft(databasePath(), projectId, threadId);
    return Response.json(result.body, { status: result.status });
  } catch (error) {
    return collaborationErrorResponse(
      error,
      "GET /api/projects/:projectId/threads/:threadId/draft",
    );
  }
}

export async function threadDraftPut(
  request: Request,
  context: RouteContext,
): Promise<Response> {
  try {
    ...
    const result = threadDraftService.saveThreadDraft(databasePath(), projectId, threadId, input);
    return Response.json(result.body, { status: result.status });
  } catch (error) {
    return collaborationErrorResponse(
      error,
      "PUT /api/projects/:projectId/threads/:threadId/draft",
    );
  }
}

export async function threadDraftDelete(
  request: Request,
  context: RouteContext,
): Promise<Response> {
  try {
    ...
    const threadId = parsePathId(params.threadId, "threadId");
    requireNoUrlSuffix(request);
    const result = threadDraftService.clearThreadDraft(databasePath(), projectId, threadId);
    return Response.json(result.body, { status: result.status });
  } catch (error) {
    return collaborationErrorResponse(
      error,
      "DELETE /api/projects/:projectId/threads/:threadId/draft",
    );
  }
}
