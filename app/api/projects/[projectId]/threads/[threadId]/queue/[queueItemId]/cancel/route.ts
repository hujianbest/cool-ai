...
export async function POST(
  ...
  try {
    ...
    const queueItemId = parsePathId(params.queueItemId, "queueItemId");
    requireNoUrlSuffix(request);
    const result = threadService.cancelQueuedMessage(
      databasePath(),
      projectId,
      threadId,
      queueItemId,
    ...
    return collaborationErrorResponse(
      error,
      "POST /api/projects/:projectId/threads/:threadId/queue/:queueItemId/cancel",
    );
  }
}
