...
function attachmentsRoot(): string {
  return process.env.COCKPIT_ATTACHMENTS_ROOT
...
export async function POST(
  ...
  try {
    ...
    const result = threadLifecycleService.purgeThread(
      databasePath(),
      attachmentsRoot(),
      projectId,
      threadId,
    ...
    return threadLifecycleErrorResponse(
      error,
      "POST /api/projects/:projectId/threads/:threadId/purge",
    );
  }
}
