...
- [x] T-01 纵向闭合 Proposal stale 对账 — Blocked by: None
...
- [x] T-02 纵向闭合 Checklist 显式新 operation 重试 — Blocked by: T-01
...
- [x] T-03 让五种 block 与 source loading 可访问 — Blocked by: T-01
  - 公共缝: fact-only Structured Block Public UI。
...
- [x] T-04 真实浏览器验收 stale reconciliation — Blocked by: T-02, T-03
