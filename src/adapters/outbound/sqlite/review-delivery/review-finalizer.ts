...
import { markReviewedWorkItemDoneTx } from "@/src/adapters/outbound/sqlite/mission-work/work-item-status-effects";
import type { ValidatedReviewOutput } from "@/src/adapters/outbound/sqlite/review-delivery/review-schema";
import {
...
export function finalizeCheckpointedReview(
  ...
  return transaction(database, () => {
    ...
    before("board");
    if (output.decision.choice === "pass") {
      const board = markReviewedWorkItemDoneTx(database, {
