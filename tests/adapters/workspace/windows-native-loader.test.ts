...
import * as nativeModule from "../../../src/adapters/outbound/workspace/windows-native-loader";
import { createDefaultSandboxFsAdapter } from "../../../src/adapters/outbound/workspace/sandbox-preflight";
