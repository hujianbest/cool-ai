...
import { createThread, startThreadRun } from "@/src/server/collaboration/thread-service";
import {
  finalizeAdvance,
...
function seed(): void {
  ...
  createMission(databasePath, PROJECT_ID, { goal: "Recover safely", title: "Recovery" });
