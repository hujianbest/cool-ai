...
const fixtures = [
  ...
  ["review_attempt_discarded", { attemptId: "attempt", category: "stale" }],
  ...
  ["work_item_passed", { decisionId: "decision", reasonCode: null, resultId: "result", workItemId: "work" }],
  ...
  ["delivery_generation_started", { category: null, inputFingerprint: HASH, operationId: "operation" }],
  ["delivery_generation_failed", { category: "storage", inputFingerprint: HASH, operationId: "operation" }],
  ["delivery_completed", { deliveryId: "delivery", deliveryVersion: 1, inputFingerprint: HASH }],
  ["delivery_invalidated", { deliveryId: "delivery", reasonCode: "CONTEXT_CHANGED", workItemIds: ["work"] }],
  ...
  ["mission_terminated", { reason: "owner stopped" }],
