...
const modules = import.meta.glob<ResolverModule>(
  "../../../src/adapters/outbound/sqlite/public-collaboration/verified-source-projection.ts",
);
let database: DatabaseSync;

async function resolver(): Promise<ResolverModule> {
  const load = modules["../../../src/adapters/outbound/sqlite/public-collaboration/verified-source-projection.ts"];
