...
const orchestratorModules =
  import.meta.glob<TurnOrchestratorModule>("../../../src/adapters/outbound/sqlite/public-collaboration/turn-orchestrator.ts");
...
async function acquire(
  ...
  const load =
    orchestratorModules["../../../src/adapters/outbound/sqlite/public-collaboration/turn-orchestrator.ts"];
