...
import type { AgentStructuredBlock } from "@/src/modules/public-collaboration";
...
const committers = import.meta.glob<CommitterModule>(
  "../../../src/adapters/outbound/sqlite/public-collaboration/action-committer.ts",
);
...
async function committer(): Promise<Required<CommitterModule>> {
  const load = committers["../../../src/adapters/outbound/sqlite/public-collaboration/action-committer.ts"];
...
async function orchestrator(): Promise<Required<OrchestratorModule>> {
  const load = orchestrators["../../../src/adapters/outbound/sqlite/public-collaboration/turn-orchestrator.ts"];
