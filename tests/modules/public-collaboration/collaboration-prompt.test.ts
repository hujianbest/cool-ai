...
const promptBuilderModules =
  import.meta.glob<PromptBuilderModule>("../../../src/adapters/outbound/sqlite/public-collaboration/prompt-builder.ts");
...
async function promptBuilder(): Promise<PromptBuilderModule> {
  const load =
    promptBuilderModules["../../../src/adapters/outbound/sqlite/public-collaboration/prompt-builder.ts"];
