...
const structuredModules = import.meta.glob<StructuredReviewModule>(
  "../../../src/adapters/outbound/sqlite/review-delivery/review-structured-repair.ts",
);
...
async function loadStructuredReview(): Promise<StructuredReviewModule> {
  const load = structuredModules["../../../src/adapters/outbound/sqlite/review-delivery/review-structured-repair.ts"];
