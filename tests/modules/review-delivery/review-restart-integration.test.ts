...
const recoveryModules = import.meta.glob<RecoveryModule>(
  "../../../src/adapters/outbound/sqlite/review-delivery/review-persistence-recovery.ts",
);
...
async function recovery() {
  const loader = recoveryModules["../../../src/adapters/outbound/sqlite/review-delivery/review-persistence-recovery.ts"];
