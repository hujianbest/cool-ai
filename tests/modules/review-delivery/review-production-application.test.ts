...
function seed(path: string): void {
  ...
  database.exec(`
    ...
    INSERT INTO work_items(
      ...
      ('work','mission','Work','Do work','in_progress','executor',1,'${NOW}','${NOW}','work-lease','2099-01-01T00:00:00.000Z','${NOW}'),
      ('other-work','mission','Other','Other work','in_progress','executor',1,'${NOW}','${NOW}','other-work-lease','2099-01-01T00:00:00.000Z','${NOW}');
...
async function application(): Promise<ApplicationModule> {
  const load = applicationModules["../../../src/adapters/outbound/sqlite/review-delivery/review-application-service.ts"];
