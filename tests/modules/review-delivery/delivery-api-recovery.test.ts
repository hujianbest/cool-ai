...
type ReadModule = typeof import("../../../src/adapters/outbound/sqlite/review-delivery/delivery-read-service");
...
async function reads(): Promise<ReadModule> {
  const load = readModules["../../../src/adapters/outbound/sqlite/review-delivery/delivery-read-service.ts"];
