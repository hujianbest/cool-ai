...
beforeEach(async () => {
  ...
  seed();
  try {
    const servicePath = "@/src/adapters/outbound/sqlite/safe-execution/execution-approval-service";
    approvals = await import(/* @vite-ignore */ servicePath) as ApprovalModule;
    const advancePath = "@/src/adapters/outbound/sqlite/safe-execution/action-orchestrator";
