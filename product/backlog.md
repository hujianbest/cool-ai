...
| S-61 / 051 | 暖米 + 暖金会话优先壳层：52px 轨 / 240px 侧栏 / 居中聊天 / 治理收轨 | 已 ship（T-06 Windows；复核工作台接线见 A-387） |
...
| 切片 | 用户结果 | 状态 |
|---|---|---|
| S-19 / 025 | 对话收藏与排序 | 已 ship |
| S-17 / 031 | 对话搜索与精确定位 | 已 ship |
